...
const Footer = () => {
    return (
        <footer className="border-t border-gray-700 bg-gray-900 py-1 text-gray-400">
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-6 md:mb-0 text-center md:text-left">
                        <h2 className="text-4xl font-bold text-gray-200">JOB<span className='text-gray-400'>IFY</span> </h2>
                        <p className="text-sm mt-2">© 2024 JOBIFY. All rights reserved.</p>
                    </div>
