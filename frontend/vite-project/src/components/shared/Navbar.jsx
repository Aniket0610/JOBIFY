        ...
        <div>
          {
             user && user.role === 'student'?(
              <>
                  <h1 className="text-4xl font-bold text-gray-200 cursor-pointer "><Link to="/">JOB<span className='text-gray-400'>IFY</span> </Link></h1>
              </>
             ):(
              <>
                <h1 className="text-4xl font-bold text-gray-200 cursor-pointer "><Link to="/admin/companies">JOB<span className='text-gray-400'>IFY</span> </Link></h1>
              </>
             )
          }
