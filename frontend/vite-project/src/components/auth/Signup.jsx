        ...
        <div className="min-h-screen bg-cover bg-center" style={{ backgroundImage: `url('https://img.freepik.com/free-photo/stationeries-keyboard-eyeglasses-white-marble-textured-background_23-2148061521.jpg?t=st=1735111496~exp=1735115096~hmac=2767afeb9d8fb651cac72f9e74f166b75cb73c75094842133e77c3cb89773e50&w=996')` }}>
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto'>
                <form onSubmit={submitHandler} className='w-1/2 border border-gray-800 rounded-md p-4 my-10 bg-white bg-opacity-10'>
                    ...
                    {
                        loading ? <Button className="w-full my-4 bg-gray-600 hover:bg-gray-700"> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Please wait </Button> : <Button type="submit" className="w-full my-4 bg-gray-600 hover:bg-gray-700">SignUp</Button>
                    }
